...

{
    ...
    if (DAT_1813070f8 != 0)
    {
        ...
        if ((uint)fVar2 < 0x7f800000)
        {
            if ((uint)fVar2 < 0x3f800001)
            {
                if ((auVar54 & (undefined1[16])0x7fffffff) == (undefined1[16])0x0)
                {
                    ...
                    auVar28._0_4_ = FUN_18105b4a4(fVar3, fVar38, (float)((uint)fVar4 | 0x400000), 3);
                ...
                if (fVar38 == 1.0)
                {
                    ...
                    auVar27._0_4_ = FUN_18105b4a4(fVar3, 1.0, (float)((uint)fVar3 | 0x400000), 3);
            ...
            if ((uint)fVar4 < 0x7f800000)
            {
                ...
                if ((int)fVar3 < 0x3f880000)
                {
                    ...
                    if ((int)fVar3 < 1)
                    {
                        if ((in_ZMM0 & (undefined1[64])0x7fffffff) == (undefined1[64])0x0)
                        {
                            ...
                            auVar26._0_4_ = FUN_18105b4a4(fVar2, fVar38, fVar2, 2);
                        ...
                        if (((uint)fVar38 & 0x7f800000) < 0x4b000001)
                        {
                            ...
                            if ((float)(int)ROUND(fVar38) != fVar38)
                            {
                                auVar36._0_4_ = FUN_18105b4a4(auVar54._0_4_, fVar38, -NAN, 6);
                ...
                dVar40 = auVar54._0_8_ *
                         ((auVar48._0_8_ * 0.6931471805599453 +
                           *(double *)(&DAT_181128610 + (ulonglong)uVar5 * 8)) -
                          dVar39);
                fVar3 = SUB84(dVar39, 0);
                if (88.72283935546875 < dVar40)
                {
                    auVar54 = vorps_avx(ZEXT416(0x7f800000), auVar43);
                    auVar35._0_4_ = FUN_18105b4a4(SUB84(dVar40, 0), fVar3, auVar54._0_4_, 9);
                ...
                if (-103.2789306640625 < dVar40)
                {
                    ...
                    auVar50._8_8_ = 0;
                    auVar50._0_8_ = *(ulonglong *)(&DAT_181130570 + (ulonglong)(auVar48._0_4_ & 0x3f) * 8);
                    auVar9._8_8_ = 0;
                ...
                auVar34._0_4_ = FUN_18105b4a4(SUB84(dVar40, 0), fVar3, auVar54._0_4_, 7);
        ...
        else
        {
            if (0x7f800000 < (uint)fVar2)
            {
                if (0x7f800000 < (uint)fVar4)
                {
                    if (fVar3 != -NAN)
                    {
                        auVar32._0_4_ = FUN_18105b4a4(fVar3, fVar38, (float)((uint)fVar3 | 0x400000), 5);
                        auVar32._4_60_ = extraout_var_17;
                        return auVar32._0_8_;
                    }
                    auVar33._0_4_ = FUN_18105b4a4(-NAN, fVar38, (float)((uint)fVar38 | 0x400000), 5);
                ...
                if (fVar3 == 1.0)
                {
                    ...
                    auVar29._0_4_ = FUN_18105b4a4(1.0, fVar38, 1.0, 4);
                    auVar29._4_60_ = extraout_var_14;
                    return auVar29._0_8_;
                }
                auVar31._0_4_ = FUN_18105b4a4(fVar38, fVar38, (float)((uint)fVar38 | 0x400000), 4);
        ...
        auVar30._0_4_ = FUN_18105b4a4(fVar3, fVar38, (float)((uint)fVar3 | 0x400000), 3);
    ...
    if (0x7f7fffff < (uint)fVar2)
    {
        if (0x7f800000 < (uint)fVar2)
        {
            if (0x7f800000 < (uint)fVar4)
            {
                if (fVar3 != -NAN)
                {
                    auVar20._0_4_ = FUN_18105b4a4(fVar3, fVar38, (float)((uint)fVar3 | 0x400000), 5);
                    auVar20._4_60_ = extraout_var_06;
                    return auVar20._0_8_;
                }
                auVar21._0_4_ = FUN_18105b4a4(-NAN, fVar38, (float)((uint)fVar38 | 0x400000), 5);
            ...
            if (fVar3 == 1.0)
            {
                ...
                auVar17._0_4_ = FUN_18105b4a4(1.0, fVar38, 1.0, 4);
                auVar17._4_60_ = extraout_var_03;
                return auVar17._0_8_;
            }
            auVar19._0_4_ = FUN_18105b4a4(fVar3, fVar38, (float)((uint)fVar38 | 0x400000), 4);
        ...
        if ((uint)fVar4 < 0x7f800001)
        {
            ...
            if ((int)fVar38 < 0)
            {
                ...
                if (bVar6)
                {
                    ...
                    if (!bVar6)
                    {
                        auVar14._0_4_ = FUN_18105b4a4(fVar3, fVar38, fVar3, 2);
    ...
    LAB_181040380:
        auVar18._0_4_ = FUN_18105b4a4(fVar3, fVar38, (float)((uint)fVar3 | 0x400000), 3);
    ...
    if ((uint)fVar2 < 0x3f800001)
    {
        if ((in_ZMM1 & (undefined1[64])0x7fffffff) == (undefined1[64])0x0)
        {
            ...
            auVar16._0_4_ = FUN_18105b4a4(fVar3, fVar38, (float)((uint)fVar4 | 0x400000), 3);
        ...
        if (fVar38 == 1.0)
        {
            ...
            auVar15._0_4_ = FUN_18105b4a4(fVar3, 1.0, (float)((uint)fVar3 | 0x400000), 3);
    ...
    if ((int)fVar3 < 0x3f880000)
    {
        if ((int)fVar3 < 1)
        {
            if ((in_ZMM0 & (undefined1[64])0x7fffffff) == (undefined1[64])0x0)
            {
                ...
                if (fVar4 != 0.0)
                {
                    auVar13._0_4_ = FUN_18105b4a4(fVar2, fVar38, fVar2, 2);
                    auVar13._4_60_ = extraout_var;
                    uVar7 = auVar13._0_8_;
                }
                /* WARNING: Read-only address (ram,0x0001811285e0) is written */
                /* WARNING: Read-only address (ram,0x0001811285f0) is written */
                /* WARNING: Read-only address (ram,0x000181128600) is written */
                return uVar7;
            }
            if (((uint)fVar38 & 0x7f800000) < 0x4b000001)
            {
                if ((float)(int)ROUND(fVar38) != fVar38)
                {
                    auVar24._0_4_ = FUN_18105b4a4(SUB84(auVar25._0_8_, 0), fVar38, -NAN, 6);
    ...
    auVar45 = auVar45 & _DAT_181128600;
    uVar5 = (auVar45._4_4_ >> 0xc) + (uint)((auVar45._0_8_ >> 0x2b & 1) != 0);
    auVar1._4_56_ = auVar52;
    auVar1._0_4_ = SUB164(auVar45 | _DAT_1811285e0, 0xc);
    dVar39 = ((double)((ulonglong)(uVar5 | 0x3fe00) << 0x2c) - SUB168(auVar45 | _DAT_1811285e0, 0)) *
             *(double *)(&DAT_181130770 + (ulonglong)uVar5 * 8);
    dVar39 = dVar39 * dVar39 * (dVar39 * 0.3333333333333333 + 0.5) + dVar39;
    fVar3 = SUB84(dVar39, 0);
    dVar39 = ((double)(int)(((ulonglong)(auVar1._0_8_ << 0x20) >> 0x34) - 0x3ff) * 0.6931471805599453 + *(double *)(&DAT_181128610 + (ulonglong)uVar5 * 8)) - dVar39;
LAB_18103fe5e:
    ...
    {
        auVar23._0_4_ =
            FUN_18105b4a4(SUB84(dVar39, 0), fVar3, (float)((uint)(float)in_XMM5_Qa | 0x7f800000), 9);
    ...
    if (-103.2789306640625 < dVar39)
    {
        ...
        auVar11._0_8_ =
            (dVar39 * dVar39 * (dVar39 * 0.16666666666666666 + 0.5) + dVar39) *
                *(double *)(&DAT_181130570 + (ulonglong)(uVar5 & 0x3f) * 8) +
            *(double *)(&DAT_181130570 + (ulonglong)(uVar5 & 0x3f) * 8);
    ...
    auVar22._0_4_ = FUN_18105b4a4(SUB84(dVar39, 0), fVar3, (float)in_XMM5_Qa, 7);
